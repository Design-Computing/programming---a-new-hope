  ...
  //'ID',                 'Parent',                   'Mark','colour', 'Quick description',                                     'full description link', 'start date',     'Submission Date',      'Full Name',      'Duration',   '% Complete',  'Dependencies', in gantt   in tree
   ...
   ['Semester',           null,                         null, null, "quick description",                                      "http://awebsite.com",    week( 1,'Monday'), week(16,'Friday'),        "Semester period", null,         0,             null,          true,    true],
      ...
      ['Weekly Tasks',      'Semester',                 17  , null, "Problems to check that you are understanding things",    "http://awebsite.com",    week( 1,'Friday'), week( 7,'Friday'),        "nice name",       null,         0,             null,          true,    true],
        ['week 1',            'Weekly Tasks',           17/6, null, "quick description",                                      "http://awebsite.com",    week( 1,'Friday'), week( 2,'Wednesday', 19), "nice name",       null,         0,             null,          true,    true],
        ['week 2',            'Weekly Tasks',           17/6, null, "quick description",                                      "http://awebsite.com",    week( 2,'Friday'), week( 3,'Wednesday', 19), "nice name",       null,         0,             'week 1',      true,    true],
        ['week 3',            'Weekly Tasks',           17/6, null, "quick description",                                      "http://awebsite.com",    week( 3,'Friday'), week( 4,'Wednesday', 19), "nice name",       null,         0,             'week 2',      true,    true],
        ['week 4',            'Weekly Tasks',           17/6, null, "quick description",                                      "http://awebsite.com",    week( 4,'Friday'), week( 5,'Wednesday', 19), "nice name",       null,         0,             'week 3',      true,    true],
        ['week 5',            'Weekly Tasks',           17/6, null, "quick description",                                      "http://awebsite.com",    week( 5,'Friday'), week( 6,'Wednesday', 19), "nice name",       null,         0,             'week 4',      true,    true],
        ['week 6',            'Weekly Tasks',           17/6, null, "quick description",                                      "http://awebsite.com",    week( 6,'Friday'), week( 8,'Wednesday', 19), "nice name",       null,         0,             'week 5',      true,    true],
  ];
