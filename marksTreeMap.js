document.addEventListener("DOMContentLoaded", function(event) {
  ...
  //'ID',                 'Parent',                   'Mark', 'colour', 'Quick description',                                     'full description link', 'start date',     'Submission Date',      'Full Name',      'Duration',   '% Complete',  'Dependencies', in gantt   in tree
   ...
   ['Semester',           null,                         null,    null, "quick description",                                      "http://awebsite.com",    week( 1,'Monday'), week(16,'Friday'),       "Semester period", null,         0,             null,          true,    true],
      ...
      ['Holy wars',         'Semester',                    5,    null, "A deep dive into programming culture",                   "http://awebsite.com",    week( 2,'Friday'), week( 5,'Friday'),       "nice name",       null,         0,             null,          true,    true],
      ...
      ['Data project',      'Semester',                   40,    null, "Working with public data",                               "http://awebsite.com",    week( 8,'Friday'), week(14,'Friday'),       "nice name",       null,         0,             null,          true,    true],
        ...
        ['data manipulation', 'Data project',      35/100*13,    null, "repeatably make the data usable",                        "http://awebsite.com",    week( 8,'Friday'), week(14,'Friday'),       "nice name",       null,         0,             null,          false,   true],
      ...
      ['Weekly Tasks',      'Semester',                   20,    null, "Problems to check that you are understanding things",    "http://awebsite.com",    week( 1,'Friday'), week( 7,'Friday'),       "nice name",       null,         0,             null,          true,    true],
        ...
        ['week 6',            'Weekly Tasks',           20/6,    null, "quick description",                                      "http://awebsite.com",    week( 6,'Friday'), week( 8,'Wednesday', 19), "nice name",       null,         0,             'week 5',      true,    true],
  ];
